...
\begin{equation}
    T_{dist}(t) = \underbrace{\frac{F_{hw}(t) \, r_{hd}}{i_h}}_{\text{Tensión de Cable}} + \underbrace{T_{hb}(t,\textcolor{cyan}{BRK_h}) + \frac{T_{hEb}(t,\textcolor{cyan}{BRK_{hE}})}{i_h}}_{\text{Fricción de Frenos}}
\end{equation}
