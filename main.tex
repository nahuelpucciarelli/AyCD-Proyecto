...
\subsubsection{Sistema de Encoders (Medición en Ejes de Motor)}
...
\begin{enumerate}
    ...
    \begin{equation}
        l_{h,enc}(t) = \theta_{hm}(t) \cdot \frac{r_{hd}}{2 \cdot i_h}
    \end{equation}
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item \textbf{Señal de entrada:} Posición real del carro $x_t$.
    ...
    \begin{itemize}
        \item \textbf{Señal de entrada:} Altura calculada por encoder $y_{enc}(t) = Y_{t0} - l_h(t)$.
        \item \textbf{Lógica de activación:}
        \begin{equation}
            FC_{h,\,\text{superior}} = 
            \begin{cases} 
