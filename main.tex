...
\graphicspath{{./Imagenes/}} % Carpeta donde se encuentran las imágenes
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Imagenes/image.png}
    \caption{Esquema del sistema de traslación del carro.}
    \label{fig:carro}
\end{figure}
