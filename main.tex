...
\begin{equation}
    J_{tm+tb} \, \frac{d\omega_{tm}(t)}{dt} = T_{tm}(t) + T_{tb}\bigl(t, BRK_t\bigr) - b_{tm} \, \omega_{tm}(t) - \frac{T_{td}(t)}{i_t}
\end{equation}
donde $T_{tm}(t)$ es el torque eléctrico, $T_{tb}(t, BRK_t)$ el del freno según su modo, y $\frac{T_{td}(t)}{i_t}$ es el torque de carga reflejado desde el tambor. 
...
\begin{itemize}
    \item Relación de transmisión: $\omega_{td}(t) = \frac{\omega_{tm}(t)}{i_t}$
    \item Conversión a lineal (en el tambor): $v_{td}(t) = r_{td} \, \omega_{td}(t)$. Nota: $v_{td}$ es la \textit{velocidad lineal del cable en el tambor}, no la del carro.
\end{itemize}
...
\end{equation}
donde $F_{coupling}(t) = 2\,F_{hw}\bigl(t, l(t) \ge l_h(t)\bigr) \, \sin\theta_l(t)$.
