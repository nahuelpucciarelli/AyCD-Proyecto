...
\begin{equation} \label{eq:eje_lento}
    J_{td} \cdot \frac{d\omega_{td}(t)}{dt} = T_{td}(t) - b_{td} \cdot \omega_{td}(t) - T_{tdl}(t)
\end{equation}
Donde $T_{tdl}(t) = F_{tw}(t) \cdot r_{td}$ es el torque de carga generado por la tensión del cable.
...
\begin{equation} \label{eq:eje_rapido}
    J_{tm+tb} \cdot \frac{d\omega_{tm}(t)}{dt} = T_{tm}(t) + T_{tb}(t,\textcolor{cyan}{BRK_t}) - b_{tm} \cdot \omega_{tm}(t) - T_{tml}(t)
\end{equation}
...
\begin{align}
    ...
    \text{Torques:} & \quad T_{td}(t) = T_{tml}(t) \cdot i_t \label{eq:rel_torque}
\end{align}
...
\begin{equation*}
    J_{td} \cdot \left( \frac{1}{i_t} \frac{d\omega_{tm}}{dt} \right) = (T_{tml} \cdot i_t) - b_{td} \cdot \left( \frac{\omega_{tm}}{i_t} \right) - T_{tdl}
\end{equation*}

Para despejar el torque de carga en el eje motor ($T_{tml}$), dividimos toda la ecuación por $i_t$:

\begin{equation}
    \underbrace{\frac{J_{td}}{i_t^2}}_{\text{Inercia Reflejada}} \cdot \frac{d\omega_{tm}}{dt} = T_{tml} - \underbrace{\frac{b_{td}}{i_t^2}}_{\text{Fricción Reflejada}} \cdot \omega_{tm} - \frac{T_{tdl}}{i_t}
\end{equation}
...
\begin{equation}
    \frac{d\omega_{tm}(t)}{dt} = \frac{1}{J_{eq}} \left[ T_{tm}(t) + T_{tb}(t) - b_{eq} \cdot \omega_{tm}(t) - \frac{r_{td}}{i_t} F_{tw}(t) \right]
\end{equation}
...
\begin{equation}
    \frac{dv_t(t)}{dt} = \frac{1}{M_t} \left[ F_{tw}(t) - b_t \cdot v_t(t) + F_{coupling}(t) \right]
\end{equation}
\begin{equation}
