...
Nota: Dado que una velocidad lineal positiva ($v_{ref} > 0$) implica ascenso, y un torque positivo del motor también implica ascenso, la conversión de referencia es directa (positiva). Sin embargo, la variable de estado del modelo $\dot{l}_h$ (\ref{l_desplegado}) representa la tasa de extensión del cable (positiva al bajar). Por lo tanto, debe invertirse para corresponder con la velocidad angular del motor (positiva al subir).
